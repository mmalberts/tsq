	...
	<div className="container">
		...
		<div className='row'>
			...
			<div className='col-md-8'>
				<p style={styles.text}>
					We are a small company that takes pride in our quality products. Know that your treasured t-shirts are in good hands. Here are the steps we will take to transform your shirts into a quilt that will last for many years:
					<br/>
					<br/>
